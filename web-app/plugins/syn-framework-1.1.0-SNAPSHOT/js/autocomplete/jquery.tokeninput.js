...
// Default settings
    var DEFAULT_SETTINGS = {
        ...
        tokenFormatter: function(item) { if(item != undefined) return "<li><p>" + item[this.propertyToSearch] + "</p></li>" },
        ...
        var input_box = $("<input type=\"text\" autocomplete=\"off\">")
            ...
            .keydown(function (event) {
                ...
                switch(event.keyCode) {
                    ...
                    case KEY.COMMA:
                        var itemValue = $(selected_dropdown_item).data("tokeninput")
                        if(itemValue != undefined && selected_dropdown_item) {
                            add_token(itemValue);
                            hidden_input.change();
                            return false;
                        }
